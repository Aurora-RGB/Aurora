...
internal static class LedMapping
{
    ...
    internal static readonly MultiValueDictionary<int, DeviceKeys> KeyboardZoneKeys = new()
    {
        ...
        { 1, DeviceKeys.E },
        { 1, DeviceKeys.R },
        { 1, DeviceKeys.CAPS_LOCK },
        { 1, DeviceKeys.A },
        { 1, DeviceKeys.S },
        { 1, DeviceKeys.D },
        { 1, DeviceKeys.LEFT_SHIFT },
        { 1, DeviceKeys.Z },
        { 1, DeviceKeys.X },
        { 1, DeviceKeys.C },
        { 1, DeviceKeys.V },
        ...
        { 3, DeviceKeys.MINUS },
        { 3, DeviceKeys.EQUALS },
        { 3, DeviceKeys.BACKSPACE },
        { 3, DeviceKeys.P },
        { 3, DeviceKeys.OPEN_BRACKET },
        { 3, DeviceKeys.CLOSE_BRACKET },
        { 3, DeviceKeys.L },
        { 3, DeviceKeys.SEMICOLON },
        { 3, DeviceKeys.APOSTROPHE },
        { 3, DeviceKeys.BACKSLASH_UK },
        { 3, DeviceKeys.HASHTAG },
        { 3, DeviceKeys.FORWARD_SLASH },
        { 3, DeviceKeys.RIGHT_SHIFT },
        { 3, DeviceKeys.RIGHT_WINDOWS },
        { 3, DeviceKeys.RIGHT_ALT },
        { 3, DeviceKeys.APPLICATION_SELECT },
        { 3, DeviceKeys.RIGHT_CONTROL },
        
        { 4, DeviceKeys.ADDITIONALLIGHT4 },
        // home zone
        { 4, DeviceKeys.PRINT_SCREEN },
        { 4, DeviceKeys.SCROLL_LOCK },
        { 4, DeviceKeys.PAUSE_BREAK },
        { 4, DeviceKeys.INSERT },
        { 4, DeviceKeys.HOME },
        { 4, DeviceKeys.PAGE_UP },
        { 4, DeviceKeys.DELETE},
        { 4, DeviceKeys.END },
        { 4, DeviceKeys.PAGE_DOWN },
        { 4, DeviceKeys.ARROW_UP },
        { 4, DeviceKeys.ARROW_LEFT },
        { 4, DeviceKeys.ARROW_DOWN },
        { 4, DeviceKeys.ARROW_RIGHT },
        
        { 5, DeviceKeys.ADDITIONALLIGHT5 },
        // numpad zone
        { 5, DeviceKeys.NUM_LOCK },
        { 5, DeviceKeys.NUM_SLASH },
        { 5, DeviceKeys.NUM_ASTERISK },
        { 5, DeviceKeys.NUM_MINUS },
        { 5, DeviceKeys.NUM_SEVEN },
        { 5, DeviceKeys.NUM_EIGHT },
        { 5, DeviceKeys.NUM_NINE },
        { 5, DeviceKeys.NUM_PLUS },
        { 5, DeviceKeys.NUM_FOUR },
        { 5, DeviceKeys.NUM_FIVE },
        { 5, DeviceKeys.NUM_SIX },
        { 5, DeviceKeys.NUM_ONE },
        { 5, DeviceKeys.NUM_TWO },
        { 5, DeviceKeys.NUM_THREE },
        { 5, DeviceKeys.NUM_ZERO },
