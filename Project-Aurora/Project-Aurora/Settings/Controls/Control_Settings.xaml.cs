...
public partial class Control_Settings
{
    ...
    public Control_Settings(Task<PluginManager> pluginManager, Task<AuroraHttpListener?> httpListener,
        Task<DeviceManager> deviceManager, Task<IpcListener?> ipcListener, Task<KeyboardLayoutManager> layoutManager)
    {
        ...
        var devicesAndWrappers = new Control_SettingsDevicesAndWrappers(deviceManager, layoutManager);
