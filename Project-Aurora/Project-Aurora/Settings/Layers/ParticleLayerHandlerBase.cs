...
public abstract class ParticleLayerHandlerBase<TParticle, TProperties>() : LayerHandler<TProperties, BitmapEffectLayer>("Particle Layer"), INotifyRender
    ...
    where TProperties : ParticleLayerPropertiesBase<TProperties>
{
    ...
    {
        var particleCtor = typeof(TParticle).GetConstructor([typeof(TProperties)]);
    ...
    protected abstract override UserControl CreateControl();
    ...
    public override EffectLayer Render(IGameState gameState)
    {
        ...
        if (_particles.Count == 0 && !Properties.SpawningEnabled)
        {
    ...
    /// <summary>
    /// Performs the logic to spawn the particles. Determines whether the particles should be spawned and
    ...
    /// </summary>
    protected void SpawnParticle() => _particles.Add(SpawnLambda(Properties));
