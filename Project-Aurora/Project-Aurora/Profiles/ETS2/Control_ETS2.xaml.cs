...
public partial class Ets2
{
    ...
    public Ets2(Application profile) {
    ...
    private bool InstallDll(bool x64) {
        var gamePath = SteamUtils.GetGamePath(227300);
    ...
    private void blinkers_SelectionChanged(object? sender, SelectionChangedEventArgs e) {
        ...
        if (_selectedBlinkerMode == BlinkerComboBoxStates.None) {
            ...
            SetLeftBlinker(_selectedBlinkerMode == BlinkerComboBoxStates.Left || _selectedBlinkerMode == BlinkerComboBoxStates.Hazard);
            SetRightBlinker(_selectedBlinkerMode == BlinkerComboBoxStates.Right || _selectedBlinkerMode == BlinkerComboBoxStates.Hazard);
        }
    }
    ...
    private void BlinkerTimer_Elapsed(object? sender, ElapsedEventArgs e) {
        ...
        if (_selectedBlinkerMode == BlinkerComboBoxStates.Left || _selectedBlinkerMode == BlinkerComboBoxStates.Hazard)
            SetLeftBlinker();
        if (_selectedBlinkerMode == BlinkerComboBoxStates.Right || _selectedBlinkerMode == BlinkerComboBoxStates.Hazard)
            SetRightBlinker();
    }
