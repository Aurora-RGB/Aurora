...
public class Map_Dota2 : Node
{
    ...
    /// </summary>
    public bool IsNightstalker_Night { get; }

    /// <summary>
    /// Current game state
    /// </summary>
    public DOTA_GameState GameState { get; }

    /// <summary>
    /// The winning team
    /// </summary>
    public PlayerTeam Win_team { get; }

    /// <summary>
    /// The name of the custom game
    /// </summary>
    public string CustomGameName { get; }

    /// <summary>
    /// The cooldown on ward purchases
    /// </summary>
    public int Ward_Purchase_Cooldown { get; }
