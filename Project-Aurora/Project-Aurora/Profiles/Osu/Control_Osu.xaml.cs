...
public partial class Control_Osu
{
    public Control_Osu(Application _) {
        InitializeComponent();
    }
    ...
    /// </summary>
    private void OpenOsuSyncRepo_Click(object? sender, RoutedEventArgs e) {
    ...
    /// </summary>
    private void SelectOsuSync(Action<string> then) {
